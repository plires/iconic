          ...
          <div class="row">
            ...
            <div class="col-lg-6 data">
              <ul>
                ...
                <li>
                  <p class="modelo">1952 alfa romeo<br><span>1900 c52</span></p>
                </li>
                <li>
                  <p class="caracteristicas">BODY NUMBER<br><span>005</span></p>
                </li>
                <li>
                  <p class="caracteristicas">ENGINE SIZE<br><span>1600</span></p>
                </li>
                <li>
                  <p class="caracteristicas">BODY STYLE<br><span>roadster</span></p>
                </li>
                <li>
                  <p class="caracteristicas">MILES<br><span>3,009</span></p>
                </li>
                <li>
                  <p class="caracteristicas">VIN<br><span>OHA005FS18</span></p>
                </li>
                <li>
                  <p class="caracteristicas">STOCK<br><span>FS18</span></p>
                </li>
              </ul>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    ...
                    <li>
                      <p class="caracteristicas_small">BODY SizE<br><span>1600</span></p>
                    </li>
                    <li>
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    <li>
                      <p class="caracteristicas_small">body number<br><span>005</span></p>
                    </li>
                    <li>
              ...
              <div class="row">
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    ...
                    <li>
                      <p class="caracteristicas_small">year<br><span>1900</span></p>
                    </li>
                    <li>
                      <p class="caracteristicas_small">miles<br><span>10900</span></p>
                    </li>
                  </ul>
                </div>
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    <li>
                      <p class="caracteristicas_small">interior Color<br><span>Burgundy</span></p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p class="caracteristicas_small">Seat Material<br><span>Leather</span></p>
                    </li>
                    <li>
