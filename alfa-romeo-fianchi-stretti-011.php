          ...
          <div class="row">
            ...
            <div class="col-lg-6 data">
              <ul>
                ...
                <li><p class="modelo">1952 alfa romeo<br><span>DISCO VOLANTE FIANCHI STRETTI</span></p></li>
                <li><p class="caracteristicas">BODY NUMBER<br><span>011</span></p></li>
                <li><p class="caracteristicas">ENGINE SIZE<br><span>2.5L</span></p></li>
                <li><p class="caracteristicas">BODY STYLE<br><span>roadster</span></p></li>
                <li><p class="caracteristicas">MILES<br><span>-</span></p></li>
                <li><p class="caracteristicas">VIN<br><span>AR119A0001175</span></p></li>
                <li><p class="caracteristicas">STOCK<br><span>82403</span></p></li>
              </ul>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    ...
                    <li><p class="caracteristicas_small">BODY SizE<br><span>2.5L</span></p></li>
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    ...
                    <li><p class="caracteristicas_small">body color<br><span>Red</span></p></li>
              ...
              <div class="row">
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    ...
                    <li><p class="caracteristicas_small">model<br><span>Disco Volante</span></p></li>
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    <li><p class="caracteristicas_small">interior Color<br><span>—</span></p></li>
