        ...
        <div class="carousel-inner">
          ...
          <div id="slide_1" class="carousel-item active">
            <div class="content">
              ...
              <div class="content_button">
                <a href="./alfa-romeo-fianchi-stretti-005.php" class="transition btn btn-primary">discover more</a>
              </div>
            </div>
          </div>
          ...
          <div id="slide_3" class="carousel-item">
            <div class="content">
              ...
              <div class="content_button">
                <a href="./mercedes-benz-ssk-recreation-003.php" class="transition btn btn-primary">discover more</a>
              </div>
            </div>
          </div>
