          ...
          <div class="row">
            ...
            <div class="col-lg-6 data">
              <ul>
                ...
                <li>
                  <p class="modelo">1966 mercedes-benz<br><span>SSK RECREATION</span></p>
                </li>
                <li>
                  <p class="caracteristicas">BODY NUMBER<br><span>002</span></p>
                </li>
                <li>
                  <p class="caracteristicas">ENGINE SIZE<br><span>manual</span></p>
                </li>
                <li>
                  <p class="caracteristicas">BODY STYLE<br><span>roadster</span></p>
                </li>
                <li>
                  <p class="caracteristicas">VIN<br><span>RPA054906</span></p>
                </li>
                <li>
                  <p class="caracteristicas">STOCK<br><span>82321</span></p>
                </li>
              </ul>
            </div>
            ...
            <div class="col-xl-6 specs">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    ...
                    <li>
                      <p class="caracteristicas_small">BODY SizE<br><span>-</span></p>
                    </li>
                    <li>
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    <li>
                      <p class="caracteristicas_small">body number<br><span>002</span></p>
                    </li>
                    <li>
                      <p class="caracteristicas_small">body color<br><span>black</span></p>
                    </li>
                    <li>
              ...
              <div class="row">
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    <li>
                      <p class="caracteristicas_small">year<br><span>1969</span></p>
                    </li>
                    <li>
                      <p class="caracteristicas_small">make<br><span>mercedes-benz</span></p>
                    </li>
                    <li>
                      <p class="caracteristicas_small">model<br><span>ssk recreation</span></p>
                    </li>
                    <li>
                ...
                <div class="col-lg-6 content_categoria">
                  ...
                  <ul>
                    ...
                    <li>
                      <p class="caracteristicas_small">Seating Type<br><span>bench</span></p>
                    </li>
                    <li>
                      <p class="caracteristicas_small">Seat Material<br><span>vinyl</span></p>
                    </li>
                    <li>
